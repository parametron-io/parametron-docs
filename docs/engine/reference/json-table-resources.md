...
Engine provides parsing, validation, canonical
...
Engine loads table files declared via `--table`
...
- [Execution Runtime](../runtime/execution-runtime.md) — Cache invalidation and metadata provenance.
