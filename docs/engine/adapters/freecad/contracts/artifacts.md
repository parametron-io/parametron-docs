...
FreeCAD owns exact CAD-native selector lookup and export execution for
declared STEP, CSV, and PDF outputs. Engine owns selector authoring/
validation and artifact acceptance into normalized records; see [Record
